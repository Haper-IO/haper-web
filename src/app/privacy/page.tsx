    ...
    <div className="flex flex-col min-h-screen">
      ...
      <main className="flex-grow container mx-auto px-4 py-16 max-w-4xl">
        <div className="my-10">
          ...
          <p className="text-sm text-gray-500 mb-8">Last Updated: 22 July, 2024</p>
          ...
          <div className="prose prose-slate max-w-none">
            ...
            <p>
              If you have questions or need to contact us about this Privacy Policy, please email our compliance officer, Nitesh Nandy at 
              privacy@haper.io
            </p>
