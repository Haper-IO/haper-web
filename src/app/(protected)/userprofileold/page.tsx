...
export default function TestProfilePage() {
  ...
  useEffect(() => {
    console.log('Current userSetting:', {
      ...
      tags: userSetting?.setting?.key_message_tags
    });
    if (userSetting?.setting?.key_message_tags) {
      setSelectedTags([...userSetting.setting.key_message_tags]);
    }
  }, [userSetting]);
                    ...
                    <div>
                      ...
                      <div className="flex justify-end gap-2">
                        <button
                          ...
                          onClick={() => {
                            const existingTags = userSetting?.setting?.key_message_tags || [];
